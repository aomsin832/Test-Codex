...
For a report-format overview, methodology explanation, automation roadmap, and self-check checklist, see [`POC_REPORT.tex`](POC_REPORT.tex). Compile it with `pdflatex POC_REPORT.tex` twice to populate the table of contents.
